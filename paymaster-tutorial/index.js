...
try {
  ...
  console.log(`⛽ View sponsored UserOperation on blockscout: https://base.blockscout.com/op/${receipt.userOpHash}`);
  console.log(`🔍 View NFT mint on basescan: https://basescan.org/address/${account.address}`);
  process.exit()
} catch (error) {
